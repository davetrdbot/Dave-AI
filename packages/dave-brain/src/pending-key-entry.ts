...
/**
 * Real gap fixed (user: "I can set up to 10 keys in the telegram and paste the settable
 ...
 * (one per line, up to 10 -- addProviderKeysBulk already enforces the cap and reports
