...
assert.deepEqual(names, ["account", "connection", "ea", "help", "menu", "models", "panic", "providers", "reset", "set_panel_group", "settings", "start_trading", "status", "stop_trading", "trades"].sort());
