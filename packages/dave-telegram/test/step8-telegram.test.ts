...
assert.deepEqual(names, ["account", "connection", "ea", "help", "models", "providers", "reset", "settings", "status"].sort());
...
assert.match(ea.webhookUrl, /^https:\/\/dave\.example\.com\/hooks\/user\/[0-9a-f]{48}$/);
